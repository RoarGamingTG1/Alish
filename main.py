...
"Hey @M3xecv, teri PUBG Lite ka record toh kamaal hai! Ek game mein 50 kills, aur woh bhi pan se! 🍳🔥",
    "In Hackaron ki PUBG Lite mein entry se pehle, noob players ka dil toot jaata hai, aur game over hone se pehle! 💣😈",
    "PUBG Lite ke Hackar, har kill ke baad ek meme bana dete hain, aur noob players ko lagta hai, ki unka game over ho gaya hai, lekin asli game toh abhi shuru hua hai! 😂🔥",
    "Inke PUBG Lite ke skills dekh kar, noob players ke dil mein hi earthquake aa jaata hai, aur unka surrender karne ka mann karta hai, lekin yeh Hackar toh sirf winner winner chicken dinner ke liye khelte hain! 🍗🎮",
    "Noob players ke liye yeh Hackar, PUBG Lite ka nightmare hote hain, aur unke bullets ka asar, unke dreams mein bhi hota hai! 💥💀",
    "Mad bhai ke hack se apne PUBG Lite ki game ko next level par le jao, aur sabko dikhao ki tu bhi ek pro player hai! Noob player hone ka dar chhod, aur Mad bhai ke guidance se apne skills ko improve karo! 🔥🚀",
    "Mad bhai ka hack use karo, aur dekho kaise teri PUBG Lite ki performance mei ek dum uchhaal aata hai! Noob player hone ka dar chhod, aur Mad bhai ke tricks ko apne advantage mei badlo! 💡🎮",
    "PUBG Lite ke battlefield mei Mad bhai ka hack use karke dekho kaise tera game ek naya level tak pahunch jaata hai! Noob player hone ka dar chhod, aur Mad bhai ke expert tips se apne skills ko polish karo! 💎🔥",
    "Mad bhai ka hack try karo, aur dekho kaise teri PUBG Lite ki game ka maza dugna ho jaata hai! Noob player hone ka dar chhod, aur Mad bhai ke hacks se apna gameplay aur bhi exciting banao! 💥🎮",
    "Noob player hone ka dar chhod, aur Mad bhai ke hack se apne PUBG Lite ki game ko ek dum pro level tak le jaao! Unka guidance follow karo, aur dekho kaise tera game ek dum naya roop dharan karta hai! 💪🔥",
    "Mad bhai ka hack use karke dekho kaise teri PUBG Lite ki game ek dum naya twist leti hai! Noob player hone ka dar chhod, aur unke expertise se apne gameplay ko aur bhi mazedaar banao! 🎮🚀",
    "PUBG Lite mei Mad bhai ke hack ka istemal karke dekho kaise teri game ki power badh jaati hai! Noob player hone ka dar chhod, aur Mad bhai ke experience se apne skills ko enhance karo! 💥💪",
    "Mad bhai ka hack try karo, aur dekho kaise teri PUBG Lite ki game ek dum unique aur powerful ho jaati hai! Noob player hone ka dar chhod, aur unke secrets se apne game ko aur bhi interesting banao! 🎮🔥",
    "Noob player hone ka dar chhod, aur Mad bhai ka hack use karke dekho kaise tera PUBG Lite ka gameplay ek dum thrilling ho jaata hai! Unke tips ko follow karo, aur apne skills ko aur bhi improve karo! 💪🚀",
    "Mad bhai ka hack use karke dekho kaise teri PUBG Lite ki game ka magic badh jaata hai! Noob player hone ka dar chhod, aur unke guidance se apne gameplay ko aur bhi exciting banao! 💫🎮",
    "PUBG Lite mei Mad bhai ka hack use karke dekho kaise tera game ek dum alag level par pahunch jaata hai! Noob player hone ka dar chhod, aur unke techniques se apne skills ko polish karo! 💎🚀",
    "Mad bhai ke hack se apne PUBG Lite ki game ko ek dum next level par le jaao, aur sabko dikhao ki tu bhi ek pro player hai! Noob player hone ka dar chhod, aur Mad bhai ke guidance se apne skills ko improve karo! 🔥🎮",
    "Mad bhai ka hack use karo, aur dekho kaise teri PUBG Lite ki performance mei ek dum uchhaal aata hai! Noob player hone ka dar chhod, aur Mad bhai ke tricks ko apne advantage mei badlo! 💡🚀",
    "PUBG Lite ke battlefield mei Mad bhai ka hack use karke dekho kaise tera game ek naya level tak pahunch jaata hai! Noob player hone ka dar chhod, aur Mad bhai ke expert tips se apne skills ko polish karo! 💎🔥",
    "Noob player hone ka dar chhod, aur Mad bhai ke hack se apne PUBG Lite ki game ko ek dum pro level tak le jaao! Unka guidance follow karo, aur dekho kaise tera game ek dum naya roop dharan karta hai! 💪🔥",
    "PUBG Lite mei Mad bhai ke hack ka istemal karke dekho kaise teri game ki power badh jaati hai! Noob player hone ka dar chhod, aur Mad bhai ke experience se apne skills ko enhance karo! 💥💪",
...
async def send_specific_reply(message):
    ...
    if username == "@VomsxNoob":
        # List of 10 specific messages
        specific_messages = [
            "Hello @M3xecv! This is a specific message for you ❤️🌟.",
            "Hey @M3xecv, just wanted to say hi!",
            "How's it going, @M3xecv?",
            "Did you know you're awesome, @M3xecv?",
            "Hope you're having a great day, @M3xecv!",
            "Keep up the good work, @M3xecv!",
            "You're doing great, @M3xecv!",
            "Sending positive vibes your way, @M3xecv!",
            "Remember to take breaks and relax, @M3xecv!",
            "Stay awesome, @M3xecv!"
    "Hey admin @M3xecv yaad dilati hoon ki main group ka asli boss hoon! 😎👑",
    "@M3xecv, aap  ko yaad dilati hoon ki har ek member ko meri sunni padti hai! 😉👍",
    "Namaste admin sahab, aur @M3xecv bhai, group ki janoon ka control toh mere paas hai! Aap dono sirf khiladi hain! 😈🃏",
    "Kya haal hai, admin bhai, aur @M3xecv? Aaj toh aap dono ka swagat hai yahan, par yaad rakho, main hoon asli boss! 😏👊",
    "Hey admin ji, aur @M3xecv, group ka Queen main hoon, aur aap dono ko yeh yaad rakhna chahiye! 😁👑",
    "Hello admin sahab, aur @M3xecv bhai, kaise ho? Kya aapko pata hai ki main yahan par sab kuch chalati hoon! 😜👨‍💼",
    "Admin bhai, aur @M3xecv, group ki sari planning aur strategy toh mere dimaag mein hoti hai, aap dono bas guest appearance kar rahe hain! 😂🧠",
    "Namaste admin ji, aur @M3xecv, group ka asli dada main hoon, aur aap dono? Aap sirf ek sidekick! 😎🤵",
    "Kya haal hai, admin bhai, aur @M3xecv? Suna hai aapko lagta hai aap group ka boss hain, par sachai toh yeh hai ki main hoon asli malik! 😂👑",
        ]
