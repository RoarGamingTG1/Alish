...
async def send_dangerous_reply(message):
    ...
    "🔒 Key Security Update: Mad Hacker ne apne mods ki keys ki security ko lekar ek strict stance liya hai aur keh diya hai ki ab users ko apni keys khud download karni padegi!",
    "🔐 Mod Key Protection: Mad Hacker ne apne mods ki keys ko protect karne ka ek strict policy announce kiya hai aur keh diya hai ki key share karne walon ko ban kiya jayega!",
    "🔒 Key Sharing Warning: Mad Hacker ne apne mods ki keys ko lekar ek strict warning di hai aur keh diya hai ki agar koi key share karega to unhein channel se nikal diya jayega!",
    "⛔ Strict Action Alert: Mad Hacker ne apne mods ki keys ko protect karne ke liye ek strict action announce kiya hai aur keh diya hai ki key share karne walon ko ban kiya jayega!",
    "❌ Key Sharing Notice: Mad Hacker ne apne mods ki keys ki security ko lekar ek important notice release kiya hai aur keh diya hai ki key share karne walon ko ban kiya jayega!",
    "🚫 Key Sharing Policy: Mad Hacker ne apne mods ki keys ko protect karne ke liye ek strict policy introduce ki hai aur keh diya hai ki agar koi key share karega to unhein channel se bahar nikal diya jayega!",
    "⛔ Key Security Alert: Mad Hacker ne apne mods ki keys ko lekar ek security alert jaari kiya hai aur keh diya hai ki key share karne walon ko ban kiya jayega!",
       "🚫 Important Announcement: Mad Hacker ne apne channel mein ladkiyon ko chhedne wale users ko kadi warning di hai aur unhein bataya hai ki agar aisa fir se hua to unhein channel se ban kiya jayega!",
    "❌ Harassment Alert: Mad Hacker ne apne channel mein ladkiyon ko chhedne wale users ko strict action ke liye threaten kiya hai aur unhein samjha diya hai ki aisa behaviour bilkul bhi bardasht nahi kiya jayega!",
    "⛔ Channel Policy Update: Mad Hacker ne apne channel ki policy mein ek important update kiya hai aur keh diya hai ki agar koi ladkiyon ko harass karega to usko turant channel se bahar nikal diya jayega!",
    "🔒 Anti-Harassment Policy: Mad Hacker ne apne channel mein harassment ko rokne ke liye ek strict anti-harassment policy introduce ki hai aur keh diya hai ki agar koi ladkiyon ko harass karega to usko ban kiya jayega!",
    "🔐 Harassment Warning: Mad Hacker ne apne channel mein ladkiyon ke liye ek harassment warning jaari ki hai aur keh diya hai ki agar koi aise harkat karta hai to usko channel se ban kiya jayega!",
